...
Value: Dictionary of dataset information.
    ...
    antimeridian: [optional] bool
        True if the dataset may cross the antimeridian. Due to poor GDAL performanc, this case
        requires special processing to correctly calculate the transform, width, and height of the
        reprojected dataset.
...
tileset_datasets = {
    ...
    "VFR Gulf Caribbean Charts": {
        "zoom": "0-12",
        "resolution": (254/3, 254/3),
        "datasets": [
            "U.S. Gulf Coast HEL",
            "Caribbean 2 VFR Chart",
            "Caribbean 1 VFR Chart",
    ...
    "Helicopter Route Chart Insets": {
        "zoom": "0-12",
        "resolution": (127/24, 127/24),
        "datasets": [
            "Chicago O'Hare Inset HEL",
            "Dallas-Love Inset HEL",
            "Washington Inset HEL",
    ...
    "IFR Area Chart Caribbean Insets": {
        "zoom": "0-12",
        "resolution": (278/6, 278/6),
        "datasets": [
            "ENR_CA02_MEX",
            "ENR_CA01_SANTIAGO",
            "ENR_CA02_MIA-NAS",
    ...
    "IFR Area Chart Insets": {
        "zoom": "0-12",
        "resolution": (139/6, 139/6),
        "datasets": [
            "ENR_A02_PHX",
            "ENR_A01_MSP",
            "ENR_A01_DCA",
    ...
    "IFR Enroute High Altitude US": {
        "zoom": "0-12",
        "resolution": (463/5, 463/5),
        "datasets": [
            "ENR_H01",
            "ENR_H02",
            "ENR_H03",
    ...
    "IFR Enroute Low Altitude Alaska Insets": {
        "zoom": "0-12",
        "resolution": (278/6, 278/6),
        "datasets": [
            "ENR_AKL01_JNU",
    ...
    "IFR Enroute Low Altitude US": {
        "zoom": "0-12",
        "resolution": (162/5, 162/5),
        "datasets": [
            "ENR_L23 Wilmington-Bimini Inset",
            "ENR_P01_GUA",
            "ENR_L21",
...
def build_vrt(vrtfile, files, resolution="average", resampling=None):
    '''
    ...
    resolution: str or tuple
        The resolution to use for the VRT. Can be one of "highest", "lowest", "average", or a tuple of (xres, yres)
    resampling: str
        The resampling method to use when resizing datasets of differing resolutions.
        If specified, can be one of nearest, bilinear, cubic, cubicspline, lanczos, average, mode
    '''
    ...
    lefts, bottoms, rights, tops, xress, yress = [], [], [], [], [], []
    for file in files:
        with rasterio.open(file) as dataset:
            ...
            # Append the resolution of the dataset
            xress.append(dataset.res[0])
    ...
    if resolution == "highest":
        ...
        raise ValueError(f'The provided resolution cannot be used: "{resolution}", please use one of "highest", "lowest", or "average".')
    ...
    for file in files:
        ...
        for i in indexes:
            ...
            attr = {"resampling": resampling} if resampling else {}
            source = ET.SubElement(vrt_raster_bands[i], "ComplexSource", attr)
